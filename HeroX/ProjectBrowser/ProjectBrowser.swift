...
struct ProjectBrowser: View {
    ...
    private let onDoneAction: ((Project) -> Void)?
    ...
    init(model: ProjectBrowserModel, onRemoveAction: ((Project) -> Void)? = nil, onDoneAction: ((Project) -> Void)? = nil) {
        self.model = model

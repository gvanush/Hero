...
class CartesianPositionFieldAnimatorBindingComponent: AnimatorBindingComponentBase<SPTAnimatableObjectProperty>, AnimatorBindingComponentProtocol {
...
struct CartesianPositionFieldAnimatorBindingView: View {
    
    @ObservedObject var component: CartesianPositionFieldAnimatorBindingComponent
    ...
    var body: some View {
        Group {
            ...
            case .valueAt0:
                FloatSelector(value: $component.binding.valueAt0, scale: $editingParams[cartesianPositionBindingOf: component.object][component.axis].valueAt0.scale, isSnappingEnabled: $editingParams[cartesianPositionBindingOf: component.object][component.axis].valueAt0.isSnapping) { editingState in
                    userInteractionState.isEditing = (editingState != .idle && editingState != .snapping)
                }
                .tint(Color.secondaryLightSelectionColor)
            case .valueAt1:
                FloatSelector(value: $component.binding.valueAt1, scale: $editingParams[cartesianPositionBindingOf: component.object][component.axis].valueAt1.scale, isSnappingEnabled: $editingParams[cartesianPositionBindingOf: component.object][component.axis].valueAt1.isSnapping) { editingState in
                   userInteractionState.isEditing = (editingState != .idle && editingState != .snapping)
                }
                .tint(Color.secondaryLightSelectionColor)
            case .none:

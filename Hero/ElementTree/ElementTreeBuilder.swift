...
@resultBuilder struct ElementBuilder {
    ...
    static func buildBlock<E1, E2, E3, E4, E5>(_ element1: E1, _ element2: E2,  _ element3: E3, _ element4: E4, element5: E5) -> TupleElement<(E1, E2, E3, E4, E5)>
    where E1: Element, E2: Element, E3: Element, E4: Element, E5: Element {
        .init((element1, element2, element3, element4, element5))
    }

    static func buildOptional<E1, E2, E3, E4, E5>(_ elements: TupleElement<(E1, E2, E3, E4, E5)>?) -> OptionalElement<E1, E2, E3, E4, E5>
    where E1: Element, E2: Element, E3: Element, E4: Element, E5: Element {
